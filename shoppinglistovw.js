...
function getShoppingLists(res, userID, connection, context, complete) {
    ...
    var query = 'SELECT listID, nameList, convert(char(10), listCreated, 103) FROM Users LEFT JOIN Lists ON Lists.userID = Users.userID WHERE Users.userID=?';
...
function getShoppingListByID(res, listID, connection, context, complete) {
  ...
  var query = 'SELECT listID, nameList, convert(char(10), listCreated, 103) FROM Lists WHERE Lists.listID=?';
