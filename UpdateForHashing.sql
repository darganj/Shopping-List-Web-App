...
CREATE TABLE `Items` (
  ...
  CONSTRAINT `Items_ibfk_2` FOREIGN KEY (`nutritionID`) REFERENCES `Nutritions` (`nutritionID`),
  CONSTRAINT `Items_ibfk_3` FOREIGN KEY (`linkID`) REFERENCES `Links` (`linkID`),
...
INSERT INTO `Items` VALUES (1,6,'Salmon Fillet',12.99,1,1),(2,3,'Chocolate Chip Muffin',0.99,3,3),(3,5,'Chicken Legs',7.45,2,2),(4,1,'Avocado',1.50,5,4),(5,1,'Plum Tomato',0.99,4,5),(6,5,'Eggs - Dozen',4.99,6,6),(7,5,'Eggs (6x)',2.99,7,6);
...
INSERT INTO `Links` VALUES (1,'https://d2d8wwwkmhfcva.cloudfront.net/800x/d2lnr5mha7bycj.cloudfront.net/product-image/file/large_9099782f-f5bd-4e7d-9aba-f1ad05e3729e.jpg'),(2,'https://previews.123rf.com/images/volff/volff1904/volff190400084/120618168-raw-chicken-leg-isolated-on-white-background-.jpg'),(3,'https://www.handletheheat.com/wp-content/uploads/2009/09/Chocolate-Chip-Muffins-SQUARE.jpg'),(4,'https://hips.hearstapps.com/amv-prod-tpw.s3.amazonaws.com/wp-content/uploads/2009/01/3201575304_488661e9e8_o.jpg?crop=1xw:0.7517899761336515xh;center,top&resize=640:*'),(5,'https://cleananddelicious.com/wp-content/uploads/2016/03/Avocad0-CD.jpg'),(6,'https://previews.123rf.com/images/kozzi/kozzi1301/kozzi130114668/17494426-close-up-of-dozen-of-eggs-in-carton-box-isolated-over-white-background.jpg'),(7,'https://img.republicworld.com/republic-prod/stories/promolarge/xxhdpi/kgik6yeyypne1qg8_1586586208.jpeg?tr=w-812,h-464');
...
INSERT INTO `Nutritions` VALUES (1,170,6),(2,264,5),(3,125,12),(4,234,21),(5,11,0),(6,75,5);
